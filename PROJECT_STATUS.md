...
- 20 MCP tools live over stdio (`devgraph/mcp/server.py`), including `impact_analysis_for_diff` from Implementation Plan #3, `find_mentions` from Implementation Plan #6, and `list_recent_changes` from Implementation Plan #7.
